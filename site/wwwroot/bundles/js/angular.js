...
}
{
  ...
  let opens = _____WB$wombat$assign$function_____("opens"); // bundle: angular___689516221558b45f3c55baa49a350cd1_m
  ...
  (function (w) {
      ...
      this.$get = [
        ...
        function (a, b, c, e, n, L, C, z, O, X) {
          ...
          function oa(a, b) {
            ...
            if ("src" === b || "ngSrc" === b) {
              if (
                -1 === ["img", "video", "audio", "source", "track"].indexOf(c)
              )
    ...
    function nd(a) {
      ...
      for (; b--; ) {
        var d = a[b];
        (8 === d.nodeType ||
          (d.nodeType === Ia && "" === d.nodeValue.trim())) &&
          sg.call(a, b, 1);
      }
      return a;
    }
      ...
      this.$get = [
        ...
        function (d, c, e, f, g) {
          ...
          if (b.enabled) {
            ...
            q =
              n.substring(0, n.indexOf("/", n.indexOf("//") + 2)) + (m || "/");
            m = e.history ? pc : Ad;
          } else ((q = Aa(n)), (m = qc));
    ...
    function pb(a, b, d, c) {
      return function (e, f, g, h, k, l, m) {
        ...
        h.$formatters.push(function (a) {
          ...
          if (n(a))
            return ((p = a) && r && (p = Yb(p, r, !0)), m("date")(a, c, r));
          p = null;
          return "";
        });
        if (u(g.min) || g.ngMin) {
            ...
            link: function (h, k, l) {
              ...
              function n(a) {
                if (a === b) {
                  ...
                  ((c = v), (c = m(c && c.split(" "), -1)), l.$removeClass(c));
                y = a;
              }
              function q(a) {
                a = c(a);
              ...
              this.recurse(
                ...
                function () {
                  k.if_(k.notNull(g.context), function () {
                    k.recurse(a.right, h);
                    m =
                      k.member(g.context, g.name, g.computed) + a.operator + h;
                    k.assign(b, m);
                    c(b || m);
                  });
                },
            ...
            if (f.$attr.ngValue) {
              ...
              f.$observe("value", function (a) {
                var d,
                  f = b.prop("selected");
                u(s) &&
                  (e.removeOption(p), delete e.selectValueMap[s], (d = !0));
                s = Pa(a);
                p = a;
                  ...
                  e.readValue = function () {
                    ...
                    p(b.find("option"), function (b) {
                      b.selected &&
                        ...
                        ((b = b.value),
                        a.push(
                          b in e.selectValueMap ? e.selectValueMap[b] : b,
                        ));
                    });
                    return a;
                  };
        ...
        ((v.$$getDefaultValue = function (a) {
          ...
          (this.Param = function (a, d, e, f) {
            ...
            function k(c, d, e) {
              if (c.type && d)
                throw new Error(
                  "Param '" + a + "' has two type configurations.",
                );
              return d
                ? d
                : c.type
                  ...
                  ((g.$template = [
                    ...
                    c.push(
                      j.resolve(g, i.globals, i.resolve, a).then(function (c) {
                        if (
                          O(d.controllerProvider) ||
                          R(d.controllerProvider)
                        ) {
  ...
  (angular.module("ui.bootstrap", [
      ...
      .controller("UibCarouselController", [
        ...
        function (n, t, i, r, u) {
          ...
          function w(i, r, h) {
            if (!y) {
              if (
                (angular.extend(i, { direction: h }),
                angular.extend(f[o].slide || {}, { direction: h }),
                u.enabled(t) &&
                  !n.$currentTransition &&
                  f[r].element &&
                  e.slides.length > 1)
                ...
                (angular.isNumber(c) &&
                  f[c].element &&
                  f[c].element.data(p, i.direction),
                  (n.$currentTransition = !0));
                u.on("addClass", f[r].element, function (t, i) {
                  i === "close" &&
                    ((n.$currentTransition = null), u.off("addClass", t));
                });
              }
          ...
          function l(n) {
            for (var t = 0; t < f.length; t++) if (f[t].slide === n) return t;
          }
          function a() {
            c && (i.cancel(c), (c = null));
          }
          ...
          var e = this,
            ...
            y = !1;
          (t.addClass("carousel"),
            (e.addSlide = function (t, i) {
              (f.push({ slide: t, element: i }),
                f.sort(function (n, t) {
                  return +n.slide.index - +t.slide.index;
                }),
                (t.index !== n.active &&
                  (f.length !== 1 || angular.isNumber(n.active))) ||
                  (n.$currentTransition && (n.$currentTransition = null),
                  (o = t.index),
                  (n.active = t.index),
                  s(o),
                  e.select(f[l(t)]),
              ...
              (f.splice(i, 1),
                f.length > 0 && o === i
                  ? i >= f.length
                    ...
                    : ((o = i), (n.active = o), s(o), e.select(f[i]))
                  : o > i && (o--, (n.active = o)),
                f.length === 0 && ((o = null), (n.active = null)));
            }),
            (e.select = n.select =
              function (t, i) {
                var r = l(t.slide);
                (i === undefined &&
                  (i = r > e.getCurrentIndex() ? "next" : "prev"),
                  t.slide.index === o ||
                    n.$currentTransition ||
                    w(t.slide, r, i));
              }),
          ...
          (n.$on("$destroy", function () {
            ...
            n.$watch("interval", v),
            n.$watchCollection("slides", b),
            n.$watch("active", function (n) {
              var t, i;
    ...
    angular.module("ui.bootstrap.position", []).factory("$uibPosition", [
      ...
      function (n, t) {
        var r,
          u,
          f = { normal: /(auto|scroll)/, hidden: /(auto|scroll|hidden)/ },
          i = {
            auto: /\s?auto?\s?/i,
        ...
        return {
          ...
          offsetParent: function (i) {
            ...
            i = this.getRawNode(i);
            for (
              var r = i.offsetParent || n[0].documentElement;
              r && r !== n[0].documentElement && u(r);
            )
              r = r.offsetParent;
          ...
          scrollbarWidth: function (i) {
            var e, f;
            return i
              ? (angular.isUndefined(u) &&
                  ((e = n.find("body")),
                  e.addClass("uib-position-body-scrollbar-measure"),
                  (u = t.innerWidth - e[0].clientWidth),
                  (u = isFinite(u) ? u : 0),
                  e.removeClass("uib-position-body-scrollbar-measure")),
                u)
              : (angular.isUndefined(r) &&
                  ((f = angular.element(
                    '<div class="uib-position-scrollbar-measure"></div>',
                  )),
                  n.find("body").append(f),
                  (r = f[0].offsetWidth - f[0].clientWidth),
                  (r = isFinite(r) ? r : 0),
                  f.remove()),
                r);
          },
          ...
          scrollParent: function (i, r, u) {
            ...
            if (
              ...
              (e = i.parentElement || h),
              e === h || o.position === "fixed")
            )
              return h;
            while (e.parentElement && e !== h) {
              if (
                ((s = t.getComputedStyle(e)),
                c && s.position !== "static" && (c = !1),
                !c && l.test(s.overflow + s.overflowY + s.overflowX))
              )
                break;
              e = e.parentElement;
            }
          ...
          position: function (i, r) {
            ...
            return (
              ...
              r &&
                ((o = t.getComputedStyle(i)),
                (u.top -= this.parseStyle(o.marginTop)),
                (u.left -= this.parseStyle(o.marginLeft))),
              (f = this.offsetParent(i)),
              (e = { top: 0, left: 0 }),
              f !== n[0].documentElement &&
                ((e = this.offset(f)),
                (e.top += f.clientTop - f.scrollTop),
                (e.left += f.clientLeft - f.scrollLeft)),
              {
                width: Math.round(
                  angular.isNumber(u.width) ? u.width : i.offsetWidth,
                ),
                height: Math.round(
                  angular.isNumber(u.height) ? u.height : i.offsetHeight,
                ),
          ...
          offset: function (i) {
            ...
            return {
              ...
              top: Math.round(
                r.top + (t.pageYOffset || n[0].documentElement.scrollTop),
              ),
              left: Math.round(
                r.left + (t.pageXOffset || n[0].documentElement.scrollLeft),
              ),
            };
          },
          viewportOffset: function (i, r, u) {
            ...
            return (
              (f.top = h.top + e.clientTop),
              (f.left = h.left + e.clientLeft),
              e === n[0].documentElement &&
                ((f.top += t.pageYOffset), (f.left += t.pageXOffset)),
              (f.bottom = f.top + e.clientHeight),
              (f.right = f.left + e.clientWidth),
              u &&
                ((o = t.getComputedStyle(e)),
                (f.top += this.parseStyle(o.paddingTop)),
                (f.bottom -= this.parseStyle(o.paddingBottom)),
                (f.left += this.parseStyle(o.paddingLeft)),
                (f.right -= this.parseStyle(o.paddingRight))),
              {
          ...
          parsePlacement: function (n) {
            var t = i.auto.test(n);
            return (
              t && (n = n.replace(i.auto, "")),
              (n = n.split("-")),
              (n[0] = n[0] || "top"),
              i.primary.test(n[0]) || (n[0] = "top"),
              (n[1] = n[1] || "center"),
              i.secondary.test(n[1]) || (n[1] = "center"),
              (n[2] = t ? !0 : !1),
              n
            );
          },
          positionElements: function (n, r, u, f) {
            ...
            if (
              ((n = this.getRawNode(n)),
              (r = this.getRawNode(r)),
              (c = angular.isDefined(r.offsetWidth)
                ? r.offsetWidth
                : r.prop("offsetWidth")),
              (l = angular.isDefined(r.offsetHeight)
                ? r.offsetHeight
                : r.prop("offsetHeight")),
              (u = this.parsePlacement(u)),
              (e = f ? this.offset(n) : this.position(n)),
              (h = { top: 0, left: 0, placement: "" }),
              u[2])
            ) {
              var o = this.viewportOffset(n, f),
                ...
                s = {
                  width:
                    ...
                    Math.round(
                      Math.abs(
                        this.parseStyle(a.marginLeft) +
                          this.parseStyle(a.marginRight),
                      ),
                    ),
                  height:
                    l +
                    Math.round(
                      Math.abs(
                        this.parseStyle(a.marginTop) +
                          this.parseStyle(a.marginBottom),
                      ),
                    ),
                };
              ((u[0] =
                u[0] === "top" && s.height > o.top && s.height <= o.bottom
                  ? "bottom"
                  : u[0] === "bottom" &&
                      s.height > o.bottom &&
                      s.height <= o.top
                    ? "top"
                    : u[0] === "left" && s.width > o.left && s.width <= o.right
                      ? "right"
                      : u[0] === "right" &&
                          s.width > o.right &&
                          s.width <= o.left
                ...
                (u[1] =
                  u[1] === "top" &&
                  s.height - e.height > o.bottom &&
                  s.height - e.height <= o.top
                    ? "bottom"
                    : u[1] === "bottom" &&
                        s.height - e.height > o.top &&
                        s.height - e.height <= o.bottom
                      ? "top"
                      : u[1] === "left" &&
                          s.width - e.width > o.right &&
                          s.width - e.width <= o.left
                        ? "right"
                        : u[1] === "right" &&
                            s.width - e.width > o.left &&
                            s.width - e.width <= o.right
                ...
                u[1] === "center" &&
                  (i.vertical.test(u[0])
                    ? ((v = e.width / 2 - c / 2),
                      o.left + v < 0 && s.width - e.width <= o.right
                        ? (u[1] = "left")
                        : o.right + v < 0 &&
                          s.width - e.width <= o.left &&
                          (u[1] = "right"))
                    : ((y = e.height / 2 - s.height / 2),
                      o.top + y < 0 && s.height - e.height <= o.bottom
                        ? (u[1] = "top")
                        : o.bottom + y < 0 &&
                          s.height - e.height <= o.top &&
                          (u[1] = "bottom"))));
            ...
            switch (u[1]) {
              ...
              case "center":
                i.vertical.test(u[0])
                  ? (h.left = e.left + e.width / 2 - c / 2)
                  : (h.top = e.top + e.height / 2 - l / 2);
            }
            return (
              (h.top = Math.round(h.top)),
              (h.left = Math.round(h.left)),
              (h.placement = u[1] === "center" ? u[0] : u[0] + "-" + u[1]),
              h
            );
          },
          adjustTop: function (n, t, i, r) {
            if (n.indexOf("top") !== -1 && i !== r)
              return { top: t.top - r + "px" };
          },
          positionArrow: function (n, r) {
            var o, f, e, u, c;
            if (
              ((n = this.getRawNode(n)),
              (o = n.querySelector(".tooltip-inner, .popover-inner")),
              o) &&
              ((f = angular.element(o).hasClass("tooltip-inner")),
              (e = f
                ? n.querySelector(".tooltip-arrow")
                : n.querySelector(".arrow")),
              e)
            ) {
              if (
              ...
              var l = "border-" + r[0] + "-width",
                ...
                h = "border-";
              ((h += i.vertical.test(r[0])
                ? r[0] + "-" + r[1]
                : r[1] + "-" + r[0]),
                (h += "-radius"),
                (c = t.getComputedStyle(f ? o : n)[h]));
              switch (r[0]) {
                case "top":
                  u.bottom = f ? "0" : "-" + s;
                  break;
        ...
        function (n, t, i) {
          ...
          ((this.isOnlyOpen = function (n, t) {
            ...
            (this.open = function (t, i, e) {
              var o, s;
              if (!r) n.on("click", f);
              (r && r !== t && (r.isOpen = !1), (r = t), e) &&
                ((o = u.get(e)),
                o
                  ? ((s = o.map(function (n) {
                      return n.scope;
                    })),
                    s.indexOf(t) === -1 && u.put(e, { scope: t }))
                  : u.put(e, { scope: t }));
            }),
            (this.close = function (t, i, e) {
              ...
              (r === t &&
                (n.off("click", f),
                n.off("keydown", this.keybindFilter),
                (r = null)),
              e) &&
                ((o = u.get(e)),
                o &&
                  ((s = o.reduce(function (n, i) {
            ...
            (f = function (n) {
              ...
              r &&
                r.isOpen &&
                ((n && r.getAutoClose() === "disabled") ||
                  (n && n.which === 3) ||
                  ((i = r.getToggleElement()),
                  n && i && i[0].contains(n.target)) ||
                  ((u = r.getDropdownElement()),
                  n &&
                    r.getAutoClose() === "outsideClick" &&
                    u &&
            ...
            (this.keybindFilter = function (n) {
              if (r) {
                ...
                n.which === 27
                  ? (n.stopPropagation(), r.focusToggleElement(), f())
                  : r.isKeynavEnabled() &&
                    [38, 40].indexOf(n.which) !== -1 &&
                    r.isOpen &&
                    (u || e) &&
                    (n.preventDefault(),
                    n.stopPropagation(),
                    r.focusDropdownEntry(n.which));
              }
            }));
        },
      ])
        ...
        function (n, t, i, r, u, f, e, o, s, h, c) {
          ...
          (t.addClass("dropdown"),
            ...
            (this.toggle = function (n) {
              return (
                (a.isOpen = arguments.length ? !!n : !a.isOpen),
                angular.isFunction(v) && v(a, a.isOpen),
                a.isOpen
              );
            }),
            ...
            (a.focusDropdownEntry = function (n) {
              var i = l.dropdownMenu
                ? angular.element(l.dropdownMenu).find("a")
                : t.find("ul").eq(0).find("a");
              switch (n) {
                case 40:
                  l.selectedOption = angular.isNumber(l.selectedOption)
                    ? l.selectedOption === i.length - 1
                      ? l.selectedOption
                      : l.selectedOption + 1
                    : 0;
                  break;
            ...
            a.$watch("isOpen", function (u, p) {
              var b = null,
                ...
                ct;
              if (
                (angular.isDefined(i.dropdownAppendTo) &&
                  ((ot = r(i.dropdownAppendTo)(a)),
                  ot && (b = angular.element(ot))),
                angular.isDefined(i.dropdownAppendToBody) &&
                  ((lt = r(i.dropdownAppendToBody)(a)), lt !== !1 && (st = !0)),
                st && !b && (b = nt),
                b && l.dropdownMenu)
              )
                if (u) {
              ...
              b &&
                ...
                (ft = 0),
                (tt = { top: it.top + "px", display: u ? "block" : "none" }),
                (et = l.dropdownMenu.hasClass("dropdown-menu-right")),
                et
                  ? ((tt.left = "auto"),
                    (ut = o.scrollbarPadding(b)),
                    ut.heightOverflow &&
                      ut.scrollbarWidth &&
                      (ft = ut.scrollbarWidth),
                    (tt.right =
                      window.innerWidth -
                      ft -
                      (it.left + t.prop("offsetWidth")) +
                      "px"))
                  : ((tt.left = it.left + "px"), (tt.right = "auto")),
                st ||
                  ((rt = o.offset(b)),
                  (tt.top = it.top - rt.top + "px"),
                  et
                    ? (tt.right =
                        window.innerWidth -
                        (it.left - rt.left + t.prop("offsetWidth")) +
                        "px")
                    : (tt.left = it.left - rt.left + "px")),
                l.dropdownMenu.css(tt));
              var at = b ? b : t,
                vt = b ? k : d,
                yt = at.hasClass(vt),
                pt = f.isOnlyOpen(n, b);
              if (
                (yt === !u &&
                  ((ht = b
                    ...
                    : u
                      ? "addClass"
                      : "removeClass"),
                  e[ht](at, vt).then(function () {
                    angular.isDefined(u) && u !== p && g(n, { open: !!u });
                  })),
                u)
              ) {
                if (l.dropdownMenuTemplateUrl)
                  c(l.dropdownMenuTemplateUrl).then(function (n) {
                    ((y = a.$new()),
                      h(n.trim())(y, function (n) {
                        var t = n;
                ...
                (f.close(a, t, b),
                  l.dropdownMenuTemplateUrl &&
                    (y && y.$destroy(),
                    (ct = angular.element('<ul class="dropdown-menu"></ul>')),
                    l.dropdownMenu.replaceWith(ct),
                    (l.dropdownMenu = ct)),
                  (l.selectedOption = null));
        ...
        return {
          ...
          link: function (n, t, i, r) {
            if (r && !angular.isDefined(i.dropdownNested)) {
              ...
              var u = i.templateUrl;
              (u && (r.dropdownMenuTemplateUrl = u),
                r.dropdownMenu || (r.dropdownMenu = t));
            }
          },
        };
      })
    ...
    angular
                ...
                resolve: function (n, u, f, e) {
                  ...
                  return (
                    angular.forEach(n, function (n) {
                      angular.isFunction(n) || angular.isArray(n)
                        ? o.push(i.resolve(t.invoke(n)))
                        : angular.isString(n)
                          ? o.push(i.resolve(t.get(n)))
                          : o.push(i.resolve(n));
                    }),
                    i.all(o).then(function (t) {
                      var i = {},
                        r = 0;
                      return (
                        angular.forEach(n, function (n, u) {
                          i[u] = t[r++];
                        }),
                        i
                      );
      ...
      .directive("uibModalBackdrop", [
        ...
        function (n, t, i) {
          function r(t, r, u) {
            u.modalInClass &&
              (n.addClass(r, u.modalInClass),
              t.$on(i.NOW_CLOSING_EVENT, function (i, f) {
                var e = f();
                t.modalOptions.animation
                  ? n.removeClass(r, u.modalInClass).then(e)
                  : e();
              }));
          }
          return {
            ...
            link: function (u, f, e) {
              ...
              (u.$$postDigest(function () {
                ...
                o.promise.then(function () {
                  var o = null;
                  (e.modalInClass &&
                    ((o = i(f, { addClass: e.modalInClass }).start()),
                    u.$on(n.NOW_CLOSING_EVENT, function (n, t) {
                      var r = t();
                      i(f, { removeClass: e.modalInClass }).start().then(r);
                    })),
                    t.when(o).then(function () {
                      var i = n.getTop(),
                        t;
                      (i && n.modalRendered(i.key),
                        (r[0].activeElement &&
                          f[0].contains(r[0].activeElement)) ||
                          ((t = f[0].querySelector("[autofocus]")),
                          t ? t.focus() : f[0].focus()));
                    }));
                }));
            },
      ...
      .factory("$uibModalStack", [
        ...
        function (n, t, i, r, u, f, e, o, s) {
          ...
          function k() {
            for (var n = -1, i = c.keys(), t = 0; t < i.length; t++)
              c.get(i[t]).value.backdrop && (n = t);
          ...
          function g(n, t) {
            ...
            (c.remove(n),
              (p = c.top()),
              p && (w = parseInt(p.value.modalDomEl.attr("index"), 10)),
              tt(
                i.modalDomEl,
                i.modalScope,
                function () {
                  ...
                  (b.remove(t, n),
                    ...
                    !u &&
                      ...
                      l.scrollbarWidth &&
                      (l.originalRight
                        ? r.css({ paddingRight: l.originalRight + "px" })
                        : r.css({ paddingRight: "" }),
                      (l = null)),
                    nt(!0));
                },
          ...
          function nt(n) {
            ...
            c.length() > 0 &&
              ((t = c.top().value),
              t.modalDomEl.toggleClass(t.windowTopClass || "", n));
          }
          function ht() {
            if (a && k() === -1) {
              var n = v;
            ...
            if (((t = c.top()), t))
              switch (n.which) {
                case 27:
                  ...
                  break;
                case 9:
                  ((i = h.loadFocusElementList(t)),
                    (r = !1),
                    n.shiftKey
                      ? (h.isFocusInFirstItem(n, i) ||
                          h.isModalFocused(n, t)) &&
                        (r = h.focusLastFocusableElement(i))
                      : h.isFocusInLastItem(n, i) &&
                        (r = h.focusFirstFocusableElement(i)),
                    r && (n.preventDefault(), n.stopPropagation()));
              }
          }
          function rt(n, t, i) {
            return !n.value.modalScope.$broadcast("modal.closing", t, i)
              .defaultPrevented;
          }
          function ut() {
            Array.prototype.forEach.call(
              ...
              function (n) {
                ...
                (n.setAttribute(y, t),
                  t ||
                    (n.removeAttribute(y), n.removeAttribute("aria-hidden")));
              },
            );
          }
          var d = "modal-open",
            ...
            c = o.createNew(),
            b = e.createNew(),
            h = { NOW_CLOSING_EVENT: "modal.stack.now-closing" },
            w = 0,
            p = null,
          ...
          return (
            ...
            (h.open = function (t, f) {
              ...
              (nt(!1),
                ...
                g >= 0 &&
                  ...
                  f.backdropClass && a.addClass(f.backdropClass),
                  f.animation && a.attr("modal-animation", "true"),
                  r(a)(v),
                  n.enter(a, e),
                  s.isScrollable(e) &&
                    ((l = s.scrollbarPadding(e)),
                    l.heightOverflow &&
                      l.scrollbarWidth &&
                      e.css({ paddingRight: l.right + "px" }))),
                f.component
                  ? ((h = document.createElement(ot(f.component.name))),
                    (h = angular.element(h)),
                    h.attr({
                      resolve: "$resolve",
                ...
                o
                  ...
                  .append(h),
                f.windowClass && o.addClass(f.windowClass),
                f.animation && o.attr("modal-animation", "true"),
                e.addClass(tt),
                f.scope && (f.scope.$$topModalIndex = w),
                n.enter(r(o)(f.scope), e),
                (c.top().value.modalDomEl = o),
                (c.top().value.modalOpener = rt),
                it(o));
            }),
            (h.close = function (n, t) {
              var i = c.get(n);
              return (ut(), i && rt(i, t, !0))
                ? ((i.value.modalScope.$$uibDestructionScheduled = !0),
                  i.value.deferred.resolve(t),
                  g(n, i.value.modalOpener),
                  !0)
                : !i;
            }),
            (h.dismiss = function (n, t) {
              var i = c.get(n);
              return (ut(), i && rt(i, t, !1))
                ? ((i.value.modalScope.$$uibDestructionScheduled = !0),
            ...
            (h.dismissAll = function (n) {
              for (var t = this.getTop(); t && this.dismiss(t.key, n); )
                t = this.getTop();
            }),
            (h.getTop = function () {
              return c.top();
            ...
            (h.isFocusInLastItem = function (n, t) {
              return t.length > 0
                ? (n.target || n.srcElement) === t[t.length - 1]
                : !1;
            }),
            (h.loadFocusElementList = function (n) {
              var t, i;
              if (n && ((t = n.value.modalDomEl), t && t.length))
                return (
                  (i = t[0].querySelectorAll(ft)),
                  i
                    ? Array.prototype.filter.call(i, function (n) {
                        return st(n);
                      })
                    : i
                );
            ...
            function (t, i, r, u, f, e, o) {
              function c(n) {
                return n.template
                  ? i.when(n.template)
                  : u(
                      angular.isFunction(n.templateUrl)
                        ? n.templateUrl()
                        : n.templateUrl,
                    );
              }
              ...
              return (
                ...
                (h.open = function (u) {
                  ...
                  var l = i.defer(),
                    ...
                    b;
                  if (
                    ((u = angular.extend({}, n.options, u)),
                    (u.resolve = u.resolve || {}),
                    (u.appendTo = u.appendTo || r.find("body").eq(0)),
                    !u.appendTo.length)
                  )
                    throw new Error(
                  ...
                  return (
                    (v = u.component
                      ? i.when(e.resolve(u.resolve, {}, null, null))
                      : i.all([c(u), e.resolve(u.resolve, {}, null, null)])),
                    (b = s =
                      i
                        .all([s])
                        .then(w, w)
                          ...
                          function (n) {
                            function b(t, r, u, f) {
                              ((t.$scope = i),
                                (t.$scope.$resolve = {}),
                                u
                                  ? (t.$scope.$uibModalInstance = h)
                                  : (t.$uibModalInstance = h));
                              var e = r ? n[1] : n;
                            ...
                            ((i.$close = h.close),
                              ...
                              i.$on("$destroy", function () {
                                i.$$uibDestructionScheduled ||
                                  i.$dismiss("$uibUnscheduledDestruction");
                              }));
                            var e = {
                                scope: i,
                                deferred: l,
                            ...
                            (u.component
                              ...
                              : u.controller &&
                                (b(v, !0, !1, !0),
                                (c = f(u.controller, v, !0, u.controllerAs)),
                                u.controllerAs &&
                                  u.bindToController &&
                                  ((r = c.instance),
                                  (r.$close = i.$close),
                  ...
                  return {
                    compile: function () {
                      ...
                      return function (n, t, r) {
                        ...
                        function kt() {
                          (!ui || n.$eval(r[c + "Enable"])) &&
                            (dt(),
                            oi(),
                            h.popupDelay
                              ? st || (st = e(ni, h.popupDelay, !1))
                              : ni());
                        }
                        function nt() {
                          (vt(),
                            h.popupCloseDelay
                              ? ot || (ot = e(d, h.popupCloseDelay, !1))
                              : d());
                        }
                        function ni() {
                        ...
                        function dt() {
                          (ot && (e.cancel(ot), (ot = null)),
                            ft && (e.cancel(ft), (ft = null)));
                        }
                        function fi() {
                          a ||
                            ((k = h.$new()),
                        ...
                        function pt() {
                          (vt(),
                            dt(),
                            si(),
                            a && (a.remove(), (a = null), ct && e.cancel(ct)),
                            v.remove(h),
                            k && (k.$destroy(), (k = null)));
                        }
                        function oi() {
                          var t, i, f;
                          ((h.title = r[c + "Title"]),
                            (h.content = ht ? ht(n) : r[u]),
                            (h.popupClass = r[c + "Class"]),
                            (h.placement = angular.isDefined(r[c + "Placement"])
                              ? r[c + "Placement"]
                              : y.placement),
                            (t = s.parsePlacement(h.placement)),
                            (it = t[1] ? t[0] + "-" + t[1] : t[0]),
                            (i = parseInt(r[c + "PopupDelay"], 10)),
                            (f = parseInt(r[c + "PopupCloseDelay"], 10)),
                            (h.popupDelay = isNaN(i) ? y.popupDelay : i),
                            (h.popupCloseDelay = isNaN(f)
                              ? y.popupCloseDelay
                              : f));
                        }
                        function ti(t) {
                          rt &&
                            angular.isFunction(rt.assign) &&
                            rt.assign(n, t);
                        }
                        function ei() {
                          ((w.length = 0),
                            ...
                            w.push(
                              r.$observe(c + "Placement", function (n) {
                                ((h.placement = n ? n : y.placement),
                                  h.isOpen && ut());
                              }),
                            ));
                        }
                        ...
                        function ii(n) {
                          h &&
                            h.isOpen &&
                            a &&
                            (t[0].contains(n.target) ||
                              a[0].contains(n.target) ||
                              nt());
                        }
                        function gt(n) {
                          n.which === 27 && nt();
                        ...
                        var a,
                          ...
                          g,
                          ct,
                          et = angular.isDefined(y.appendToBody)
                            ? y.appendToBody
                            : !1,
                          b = p(undefined),
                          ...
                          h = n.$new(!0),
                          wt = !1,
                          rt = angular.isDefined(r[c + "IsOpen"])
                            ? l(r[c + "IsOpen"])
                            : !1,
                          ...
                          ut = function () {
                            a &&
                              ...
                              (g ||
                                (g = e(
                                  function () {
                                    var n = s.positionElements(
                                        t,
                                        a,
                                        h.placement,
                                        et,
                                      ),
                                      r = angular.isDefined(a.offsetHeight)
                                        ? a.offsetHeight
                                        : a.prop("offsetHeight"),
                                    ...
                                    (a.css({
                                      ...
                                      (i = n.placement.split("-")),
                                      a.hasClass(i[0]) ||
                                        (a.removeClass(it.split("-")[0]),
                                        a.addClass(i[0])),
                                      a.hasClass(
                                        y.placementClassPrefix + n.placement,
                                      ) ||
                                        (a.removeClass(
                                          y.placementClassPrefix + it,
                                        ),
                                        a.addClass(
                                          y.placementClassPrefix + n.placement,
                                        )),
                                      ...
                                      a.hasClass("uib-position-measure")
                                        ? (s.positionArrow(a, n.placement),
                                          a.removeClass("uib-position-measure"))
                                        : it !== n.placement &&
                                          s.positionArrow(a, n.placement),
                                      (it = n.placement),
                                      (g = null));
                        ...
                        ((h.origScope = n),
                          ...
                          ri(),
                          (yt = n.$eval(r[c + "Animation"])),
                          (h.animation = angular.isDefined(yt)
                            ? !!yt
                            : y.animation),
                          (lt = c + "AppendToBody"),
                          (at =
                            lt in r && r[lt] === undefined
                              ? !0
                              : n.$eval(r[lt])),
                          (et = angular.isDefined(at) ? at : et),
                          n.$on("$destroy", function () {
                            (bt(), pt(), (h = null));
                          }));
                      };
        ...
        function (n, t, i, r) {
          return {
            link: function (u, f, e) {
              ...
              (u.$watch(
                t.parseAsResourceUrl(e.uibTooltipTemplateTransclude),
                function (t) {
                  var e = ++l;
                  t
                    ? (r(t, !0).then(
                      ...
                      u.$emit("$includeContentRequested", t))
                    : c();
                },
              ),
                u.$on("$destroy", c));
          ...
          return {
            ...
            link: function (t, i, r) {
              ...
              (t.popupClass && i.addClass(t.popupClass),
                t.animation && i.addClass(r.tooltipAnimationClass));
            },
          };
        },
      ])
    ...
    function n(n) {
      ...
      for (
        ...
        if (
          ...
          for (r = n.querySelectorAll("." + u), t = 0; t < r.length; t++)
            e(r[t]);
          for (
            r = n.querySelectorAll("." + u + "\\:"), t = 0;
            t < r.length;
            t++
          )
            e(r[t]);
      ...
      for (i = 0; i < o.length; i++) {
        ...
        if (l) (f.push(n), s.push((l[2] || "").replace(/\s+/g, ",")));
          ...
          for (t = 0; t < n.attributes.length; t++)
            ((c = n.attributes[t]),
              h.indexOf(c.name) != -1 && (f.push(n), s.push(c.value)));
      }
      for (i = 0; i < f.length; i++)
        ((a = f[i]),
          (v = s[i].replace(/ /g, "").split(",")),
          angular.bootstrap(a, v));
    }
            ...
            link: function (r, u, f, e) {
              ...
              function y() {
                ...
                (g !== o && nt(),
                  a ||
                    ((a = !0),
                    (h.value = o.value + et),
                    (h.style.overflowY = o.style.overflowY),
                    (u =
                      o.style.height === ""
                        ? "auto"
                        : parseInt(o.style.height, 10)),
                    (i = getComputedStyle(o).getPropertyValue("width")),
                    i.substr(i.length - 2, 2) === "px" &&
                      ((f = parseInt(i, 10) - p.width),
                      (h.style.width = f + "px")),
                    (t = h.scrollHeight),
                    t > c ? ((t = c), (e = "scroll")) : t < k && (t = k),
                    (t += p.height),
                    (o.style.overflowY = e || "hidden"),
                    u !== t &&
                      (r.$emit("elastic:resize", v, u, t),
                      (o.style.height = t + "px")),
                    n(function () {
                      a = !1;
                    }, 1)));
              ...
              if (o.nodeName === "TEXTAREA" && t.getComputedStyle) {
                ...
                var et = f.msdElastic
                  ...
                  tt = angular
                    .element(
                      '<textarea aria-hidden="true" tabindex="-1" style="' +
                        b +
                        '"/>',
                    )
                    .data("elastic", !0),
                  ...
                  p = rt
                    ? {
                        width:
                          ...
                          parseInt(s.getPropertyValue("border-left-width"), 10),
                        height:
                          parseInt(s.getPropertyValue("border-top-width"), 10) +
                          parseInt(s.getPropertyValue("padding-top"), 10) +
                          parseInt(s.getPropertyValue("padding-bottom"), 10) +
                          parseInt(
                ...
                v.data("elastic") ||
                  ...
                  v
                    ...
                    .data("elastic", !0),
                  (o.oninput =
                    "onpropertychange" in o && "oninput" in o
                      ? (o.onkeyup = y)
                      : y),
                  d.bind("resize", l),
                  r.$watch(
