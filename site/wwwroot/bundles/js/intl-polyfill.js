...
}
{
  ...
  let opens = _____WB$wombat$assign$function_____("opens"); // bundle: intl-polyfill___072305cc64e366a0bf53573df1922ede_m
      ...
      for (var n = a(e), i = s(n.length), o = 0; o < i; ) {
        ...
        if (c) {
          ...
          if (
            ...
            ("string" != typeof u &&
              "object" !==
                ("undefined" == typeof u ? "undefined" : Ne.typeof(u)))
          )
            ...
            switch (y) {
              ...
              case "weekday":
                try {
                  ...
                  throw new Error(
                    "Could not find weekday data for locale " + i,
                  );
                }
                break;
              case "timeZoneName":
