...
}
{
  ...
  (function () {
    function et(t) {
      ...
      return function (u, f, o, s) {
        ...
        var h = !i(u) && n.keys(u),
          ...
          c = t > 0 ? 0 : l - 1;
        return (
          arguments.length < 3 && ((o = u[h ? h[c] : c]), (c += t)),
          r(u, f, o, h, c, l)
        );
      };
    }
    ...
    function ut(t, i, f) {
      return function (e, o, s) {
        ...
        if ("number" == typeof s)
          t > 0
            ? (c = s >= 0 ? s : Math.max(s + h, c))
            : (h = s >= 0 ? Math.min(s + 1, h) : s + h + 1);
    ...
    function ft(t, i) {
      ...
      for (n.has(t, r) && !n.contains(i, r) && i.push(r); u--; )
        ((r = k[u]), r in t && t[r] !== e[r] && !n.contains(i, r) && i.push(r));
    }
    var a = this,
      lt = a._,
      l = Array.prototype,
    ...
    var b = function (n, t) {
        return function (i) {
          ...
          for (r = 1; e > r; r++)
            for (
              var o = arguments[r], s = n(o), h = s.length, f = 0;
              h > f;
              f++
            )
    ...
    ((n.each = n.forEach =
      ...
      (n.find = n.detect =
        function (t, r, u) {
          var f;
          return (
            (f = i(t) ? n.findIndex(t, r, u) : n.findKey(t, r, u)),
      ...
      (n.every = n.all =
        function (r, u, f) {
          ...
          u = t(u, f);
          for (
            var o = !i(r) && n.keys(r), h = (o || r).length, e = 0;
            h > e;
            e++
          )
      ...
      (n.shuffle = function (t) {
        for (
          var u, e = i(t) ? t : n.values(t), o = e.length, f = Array(o), r = 0;
          o > r;
          r++
        )
      ...
      (n.last = function (t, i, r) {
        if (null != t)
          return null == i || r
            ? t[t.length - 1]
            : n.rest(t, Math.max(0, t.length - i));
      }),
      (n.rest =
        n.tail =
        n.drop =
      ...
      (f = function (t, r, e, o) {
        for (var s, l, a, h = [], v = 0, c = o || 0, y = u(t); y > c; c++)
          if (((s = t[c]), i(s) && (n.isArray(s) || n.isArguments(s))))
            for (
              r || (s = f(s, r, e)), l = 0, a = s.length, h.length += a;
              a > l;
            )
              h[v++] = s[l++];
          else e || (h[v++] = s);
      ...
      (n.intersection = function (t) {
        for (
          var r, i, f = [], o = arguments.length, e = 0, s = u(t);
          s > e;
          e++
        )
      ...
      (n.unzip = function (t) {
        for (
          var r = (t && n.max(t, u).length) || 0, f = Array(r), i = 0;
          r > i;
          i++
        )
          f[i] = n.pluck(t, i);
      ...
      (n.range = function (n, t, i) {
        ...
        for (
          var u = Math.max(Math.ceil((t - n) / i), 0), f = Array(u), r = 0;
          u > r;
          r++, n += i
        )
          f[r] = n;
      ...
      (s = function (t, i, r, u) {
        ...
        if ((r.push(t), u.push(i), a)) {
          ...
          for (; f--; ) if (!s(t[f], i[f], r, u)) return !1;
        } else {
    ...
    SetCustomVar: function (n, t, i, r) {
      window._gaq &&
        (window.GoogleAnalyticsDisableRoblox2 ||
          _gaq.push(["_setCustomVar", n, t, i, r]),
      ...
      window._gaq &&
        (window.GoogleAnalyticsDisableRoblox2 ||
          ...
          GoogleAnalyticsEvents.LocalEventLog.push(
            makeGoogleAnalyticsLogObject(t),
          )),
        (i = ["b._trackEvent"]),
        (i = i.concat(n)),
        _gaq.push(i),
        GoogleAnalyticsEvents.LocalEventLog.push(
          makeGoogleAnalyticsLogObject(i),
        ));
    },
    ...
    TrackTransactionItem: function (n, t, i, r, u) {
      if (window._gaq) {
        ...
        (window.GoogleAnalyticsDisableRoblox2 ||
          (_gaq.push(f),
          GoogleAnalyticsEvents.LocalEventLog.push(
            makeGoogleAnalyticsLogObject(f),
          ),
          _gaq.push(e),
          GoogleAnalyticsEvents.LocalEventLog.push(
            makeGoogleAnalyticsLogObject(e),
          )),
          (f[0] = "b." + f[0]),
          (e[0] = "b." + e[0]),
          _gaq.push(f),
  ...
  function RBXBaseEventListener() {
    ...
    ((this.init = function () {
      for (eventKey in this.events)
        this.events.hasOwnProperty(eventKey) &&
          $(document).bind(
            this.events[eventKey],
            $.proxy(this.localCopy, this),
          );
    }),
      (this.events = []),
  ...
  RobloxEventManager = new (function () {
    ...
    ((this.enabled = !1),
      ...
      (this.initialize = function (n) {
        for (
          this.initialized = !0, this.enabled = n;
      ...
      (this.triggerEvent = function (n, t) {
        this.initialized
          ...
          : this.eventQueue.push({ eventName: n, args: t });
      }),
      ...
      (this.monitorCookieStore = function () {
        ...
        try {
          if (
            ...
            typeof Roblox.Client == "undefined" ||
      ...
      switch (n.type) {
        ...
        case "rbx_evt_card_redemption":
          ((t.category = "CardRedemption"),
            (i = { merchant: "action", cardValue: "opt_label" }));
          break;
        default:
          return (
            console.log(
  ...
  ((Roblox = Roblox || {}),
    typeof Roblox.UpsellAdModal == "undefined" &&
  ...
  (typeof Roblox == typeof undefined && (Roblox = {}),
    ...
    (Roblox.Endpoints.ajaxPrefilter = function (n) {
      var r = Roblox.Endpoints.generateAbsoluteUrl(
        n.url,
        n.data,
        n.crossDomain,
      );
    ...
    $.ajaxPrefilter(Roblox.Endpoints.ajaxPrefilter)); // utilities/deviceFeatureDetection.js

  ((Roblox = Roblox || {}),
    (Roblox.DeviceFeatureDetection = (function () {
      function i() {
        !t.hasClass("in-studio") &&
          ("ontouchstart" in window ||
            navigator.maxTouchPoints > 0 ||
            navigator.msMaxTouchPoints > 0) &&
          ((n = !0), t.addClass("touch"));
      }
      var n = !1,
        t = $(".container-main");
      return (i(), { isTouch: n });
  ...
  Roblox.UrlParser = (function () {
    ...
    return { getParameterValueByName: n, addOrUpdateQueryStringParameter: t };
  ...
  ((Roblox.SubmitButton = (function () {
    ...
    function h(i, r, u) {
      return function (f) {
        ...
        if (((o = !1), r)) {
          for (
            s = r.object.split("."), e = window[s[0]], h = 1;
            h < s.length;
            h++
          )
            e = e[s[h]];
          if (e && ((c = e[r.func]), typeof c == "function"))
            try {
              (c(), (o = !0));
            } catch (f) {
              o = !1;
    ...
    return { init: s, submitToggleEvent: t };
  })()),
    $(function () {
  ...
  (typeof Roblox == "undefined" && (Roblox = {}),
    (Roblox.XsrfToken = (function () {
      ...
      var r = ["POST", "PUT", "DELETE", "PATCH"],
        n = "",
        t = "X-CSRF-TOKEN",
        u = 403,
        i;
      return (
        $(document).ajaxSend(function (t, i, u) {
          n !== "" &&
            r.indexOf(u.type.toUpperCase()) >= 0 &&
            i.setRequestHeader("X-CSRF-TOKEN", n);
        }),
        $.ajaxPrefilter(function (i, r, f) {
          if (i.dataType != "jsonp" && i.dataType != "script" && n !== "") {
            (r.error && (r._error = r.error), (i.error = $.noop()));
            var e = $.Deferred();
            return (
              f.done(e.resolve),
              f.fail(function () {
                ...
                if (f.status == u && f.getResponseHeader(t) != null) {
                  if (((i = f.getResponseHeader(t)), i == null)) {
                    e.rejectWith(f, o);
                    return;
                  }
                  ((n = i), $.ajax(r).then(e.resolve, e.reject));
                } else (r._error && e.fail(r._error), e.rejectWith(f, o));
              }),
              e.promise(f)
            );
          }
        }),
        (i = { setToken: f, getToken: e })
      );
    })())); // DeveloperConsoleWarning.js

  (typeof Roblox == "undefined" && (Roblox = {}),
    typeof Roblox.DeveloperConsoleWarning == "undefined" &&
  ...
  ((Roblox.Navigation = (function () {
    "use strict";
    function n(n, t) {
      (n.attr("href", t.Url), n.attr("data-count", t.TotalCount));
    ...
    function i(n) {
      ...
      (n.HasError &&
        (t
          .children()
          .wrapAll(
            "<span id='nav-robux-error' data-toggle='tooltip' data-original-title='" +
              n.ErrorMessage +
    ...
    function u() {
      var t = "/messages/api/unread-messages-summary";
      $.ajax({
        url: t,
        success: function (t) {
          var i = $("#nav-message");
    ...
    $(function () {
      ...
      function o(n) {
        var i = $(
            '[data-behavior="univeral-search"] .rbx-navbar-search-option',
          ),
          t = -1;
        ($.each(i, function (n, i) {
      ...
      n.on("keydown", function (n) {
        var t = $(this).val();
        (n.which === 9 || n.which === 38 || n.which === 40) &&
          t.length > 0 &&
          (n.stopPropagation(), n.preventDefault(), o(n));
      });
      n.on("keyup", function (n) {
        ...
        n.which === 13
          ...
          : r.length > 0
            ? (t.toggleClass("rbx-navbar-search-open", !0),
              $(".rbx-navbar-search-option").each(function () {
                var n = $(this),
                  t = n.data("searchurl");
                (n.find(".rbx-navbar-search-string").text(r),
                  n
                    .find(".rbx-navbar-search-anchor")
                    .attr("href", t + encodeURIComponent(r)));
              }))
        ...
        function (n) {
          ...
          (n.stopPropagation(),
            ...
            typeof angular == "undefined" ||
              angular.isUndefined(angular.element("#chat-container").scope()) ||
              ((t = angular.element("#chat-container").scope()),
              t.$digest(t.$broadcast("Roblox.Chat.destroyChatCookie"))),
            $.post(i.attr("data-bind"), { redirectTohome: !1 }, function () {
              var t =
      ...
      ((u = function (n) {
        ...
        typeof n == "string" &&
          (n.indexOf("resize") != -1 &&
            ((t = n.split(",")), $("#iframe-login").css({ height: t[1] })),
          n.indexOf("fbRegister") != -1 &&
            ...
            (window.location.href =
              "../Login/Default.aspx?iFrameFacebookSync=true" + i)));
      }),
        $.receiveMessage &&
      ...
      $("body").on("click touchstart", function (n) {
        ($('[data-behavior="univeral-search"]').each(function () {
          ($(this).is(n.target) ||
            $(this).has(n.target).length !== 0 ||
            $(this).removeClass("rbx-navbar-search-open"),
            $(this).has(n.target).length === 0 &&
              $('[data-toggle="toggle-search"]').has(n.target).length === 0 &&
              $('[data-behavior="univeral-search"]').css("display") ===
                "block" &&
              $('[data-behavior="univeral-search"]').removeClass("show"));
        }),
          $(n.target).closest("#login-dropdown").length ||
            $(n.target).is("#login-dropdown") ||
            $(n.target).closest("#head-login").length ||
            $(n.target).is("#head-login") ||
            ($("#login-dropdown").hasClass("show") &&
  ...
  ((Roblox.BootstrapWidgets = (function () {
    ...
    function d() {
      ...
      else $('[data-toggle="tooltip"]').tooltip({ placement: "bottom" });
    }
    function k(n, t) {
      ...
      $("body").on("click touchstart", function (n) {
        $('[data-toggle="popover"]').each(function () {
          if (!$(this).is(n.target) && $(this).has(n.target).length === 0) {
            ...
            (n.type === "touchstart" && $(".popover").has(n.target).length > 0
              ? (t = !0)
              : n.type === "click" && (t = !0),
              t && $(this).popover("hide"));
          }
    ...
    function v() {
      var n = $('[data-toggle="pagination"]'),
        t = $('[data-toggle="pager"]');
      (n.twbsPagination || t.twbsPagination) &&
        (n.twbsPagination({
          totalPages: 35,
          visiblePages: 7,
          first: 1,
    ...
    function n(n, t, i, r) {
      if (typeof n != "undefined") {
        var u, f;
        (r && ((u = n.clone()), u.html(r), n.after(u), (f = n.detach())),
      ...
      $("input[placeholder]")
        .focus(function () {
          ...
          n.val() == n.attr("placeholder") &&
            (n.val(""), n.removeClass("rbx-placeholder"));
        })
        .blur(function () {
          var n = $(this);
          (n.val() == "" || n.val() == n.attr("placeholder")) &&
            (n.addClass("rbx-placeholder"), n.val(n.attr("placeholder")));
        });
    }
    function s() {
      h.each(function () {
        ...
        (n.width(t.width()),
          $("body").append(n),
          n.height() <= t.height() &&
            (t.removeClass(i), $(this).find(".toggle-para").hide()),
          n.remove());
      });
    }
    function o(n, t) {
      ...
      var n = "para-overflow-toggle-off",
        ...
        i = function () {
          $(this).bind("click touchstart", function () {
            ...
            $(this).text() === r
              ? (i.removeClass(t).addClass(n), $(this).text(u))
              : (i.removeClass(n).addClass(t), $(this).text(r));
          });
        };
      $(".toggle-para").each(i);
    }
    function f() {
      ...
      ($(".toggle-content").removeClass("hidden"),
        t.each(function () {
          ...
          (o.removeClass("hide"),
            (u.height() <= t.height() || !e.is(":visible")) &&
              (t.removeClass(n).removeClass(i), e.hide(), o.addClass("hide")),
            t.removeClass(r),
            u.remove());
        }));
    }
          ...
          ($(this).unbind("click"),
            $(this).bind("click", function () {
              var f = $(this).data("container-id"),
                u = $("#" + f);
              $(this).text() === i
                ? (u.removeClass(t).addClass(n),
                  $(this).text(r),
                  u.find(".show-more-end").addClass("hide"))
                : (u.removeClass(n).addClass(t),
                  $(this).text(i),
    ...
    function r(n) {
      ((n = n ? n : "#carousel"),
        $(n).carousel({ interval: 6e3, pause: "hover" }));
    }
    function it() {
      ...
      if (Roblox.CookieUpgrader.domain !== "" && ((i = e(n)), i != null))
        try {
          ...
          ((u = r + "=" + i + "; "),
            ...
            (h = { cookieName: n, cookieValue: i, newCookieName: r }),
            Roblox.EventStream &&
              Roblox.EventStream.SendEventWithTarget(
                "CookieUpgrader",
                "ConvertedCookie",
  ...
  "modal" in $.fn &&
    "noConflict" in $.fn.modal &&
    ($.fn.bootstrapModal = $.fn.modal.noConflict()); // common/robloxError.js
  ...
  Roblox.ThumbnailMetrics = (function () {
    ...
    function o(i, r) {
      ...
      $.ajax({
        ...
        crossDomain: !0,
        xhrFields: { withCredentials: !0 },
        data: { duration: i, loadState: f.complete, thumbnailType: r },
      });
    }
    function s(i) {
      ...
      $.ajax({
        ...
        crossDomain: !0,
        xhrFields: { withCredentials: !0 },
        data: { loadState: f.timeout, thumbnailType: i },
      });
    }
    var r =
        (Roblox.EnvironmentUrls && Roblox.EnvironmentUrls.metricsApi) ||
        "https://web.archive.org/web/20200731233919/https://metrics.roblox.com",
      u = r + "/v1/thumbnails/load",
      h = r + "/v1/thumbnails/metadata",
      f = { complete: "complete", timeout: "timeout" },
      n = !1,
      t = [],
      i = 0;
    return (
