...
}
{
        ...
        return (
          (function (e, t, r) {
          ...
          })(n, [
            {
              ...
              value: function (e, t) {
                ...
                return (
                  r ||
                    console.warn(
                      "The translation key '".concat(
                        e,
                        "' not found. Please check for a missing string or a typo.",
                      ),
                    ),
                  void 0 !== t &&
                    (r =
                      t && "object" === i(t) && !Array.isArray(t)
                        ? r
                          ? this.intl.f(r, t)
                          : ""
            ...
            },
            {
              ...
              value: function (e, t) {
                if (this.resourceMap[e])
                  throw new Error("'key' ".concat(e, " is already present"));
            ...
            c(n, [
              {
                ...
                value: function (e) {
                  var t = (function (t) {
                    ...
                    {},
                    null === o.LangDynamicDefault ||
                      void 0 === o.LangDynamicDefault
                      ? void 0
                      : o.LangDynamicDefault[e],
                    null === o.Lang || void 0 === o.Lang ? void 0 : o.Lang[e],
                    null === o.LangDynamic || void 0 === o.LangDynamic
                      ? void 0
                      : o.LangDynamic[e],
                  );
                  return (
                    0 === Object.keys(t).length &&
                      console.warn(
                        "The namespace ".concat(e, " was not found"),
                      ),
                    new l(this.intl, t, e)
                  );
                },
              },
              {
                ...
                value: function () {
                  for (
                    ...
                    t[r] = arguments[r];
                  return n.combineTranslationResources.apply(
                    n,
                    [this.intl].concat(t),
                  );
                },
    ...
    2: function (e, t, r) {
        ...
        (i.prototype.compileArgument = function (e) {
          ...
          switch (t.type) {
            case "numberFormat":
              return (
                (r = n.number[t.style]),
                { id: e.id, format: new Intl.NumberFormat(o, r).format }
              );
            case "dateFormat":
              return (
                (r = n.date[t.style]),
                { id: e.id, format: new Intl.DateTimeFormat(o, r).format }
              );
            case "timeFormat":
              return (
                (r = n.time[t.style]),
            ...
            case "pluralFormat":
              return (
                ...
                new l(e.id, t.ordinal, t.offset, r, a)
              );
            case "selectFormat":
      ...
      var p =
          ...
          (n.prototype = new f()),
          {
            ...
            parse: function (l) {
              var e,
                t = 1 < arguments.length ? arguments[1] : {},
                s = {},
                r = { start: je },
                n = je,
                o = function (e) {
                ...
                B = { type: "other", description: "optionalWhitespace" },
                J = /^[0-9]/,
                  ...
                  (e =
                    ...
                    Re() !== s
                      ? (123 === l.charCodeAt(ve)
                          ? ((r = f), ve++)
                          : ((r = s), 0 === ke && Le(p)),
                        r !== s && Re() !== s && (n = Ae()) !== s && Re() !== s
                          ? (125 === l.charCodeAt(ve)
                              ? ((o = y), ve++)
                              : ((o = s), 0 === ke && Le(d)),
                            o !== s ? ((be = e), I(t, n)) : ((ve = e), s))
                          : ((ve = e), s))
                      : ((ve = e), s))
                );
              }
              ...
              throw (
                e !== s &&
                  ve < l.length &&
                  Le({ type: "end", description: "end of input" }),
                _e(
                  null,
                  Oe,
                  Fe < l.length ? l.charAt(Fe) : null,
                  Fe < l.length ? De(Fe, Fe + 1) : De(Fe, Fe),
                )
              );
            },
          }),
      ...
      function h(e, t, r) {
        ...
        ((r = this._mergeFormats(h.formats, r)),
      ...
      (Object.defineProperty(h, "formats", {
        ...
        Object.defineProperty(h, "__parse", { value: p.parse }),
        ...
        (h.prototype._format = function (e, t) {
          ...
          for (r = 0, n = e.length; r < n; r += 1)
            if ("string" != typeof (o = e[r])) {
              if (
                ((a = o.id), !t || !Object.prototype.hasOwnProperty.call(t, a))
              )
                throw new Error("A value must be provided for: " + a);
              ((i = t[a]),
                o.options
                  ? (u += this._format(o.getOption(i), t))
                  : (u += o.format(i)));
            } else u += o;
          return u;
        }),
      ...
      function x() {
        var e,
          t =
            ...
            (d.LocalStorage
              ? d.LocalStorage.isAvailable()
              : localStorage && localStorage.getItem && localStorage.setItem),
          r = document.querySelector(b);
        return (
          r &&
            (e = r.dataset
              ? r.dataset.languageCode
              : r.getAttribute("data-language-code")),
          !e && t && (e = localStorage.getItem(g)),
          (e = e || w),
          t && localStorage.setItem(g, e),
          e
        );
      }
      var D = {
          ...
          (function (e, t, r) {
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                return (
                  this.getCustomDateTime(e, A[0]) +
                  r +
                  this.getCustomDateTime(e, A[1])
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function () {
                var r = C,
                  ...
                  t = [
                    { type: "year", index: e.indexOf("2003") },
                    { type: "month", index: e.indexOf("8") },
                    { type: "day", index: e.indexOf("17") },
                  ];
      ...
      var U = function (e) {
        return {
          currency: { style: "currency", currency: e },
      ...
      var B = (function () {
        function o(e, t, r) {
          ...
          ((this.locale = (function (e) {
            ...
            (this.timeZone = t || "America/Los_Angeles"),
            (this.currency = r || "USD"),
            (this.monthsList = {}),
            (this.weekdaysList = {}),
            (this.langSensitiveCompare = z(this.locale)),
          ...
          (function (e, t, r) {
              ...
              value: function () {
                return (
                  this.dateTimeFormatter ||
                    (this.dateTimeFormatter = new R(this.locale)),
                  this.dateTimeFormatter
                );
              },
            },
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                return (
                  (this.monthsList[r] && 0 < this.monthsList[r].length) ||
                    (this.monthsList[r] = (function (r, n, o) {
                      return j
                        .map(function (e) {
            ...
            },
            {
              ...
              value: function (e, t) {
                if (
                  ...
                  "object" !== W(e) || !Date.prototype.isPrototypeOf(e))
                )
                  throw new TypeError(
                    "'dateObj' must be a JavaScript date object",
                  );
                var r;
            ...
            },
            {
              ...
              value: function (e, t) {
                if (Number.isNaN(e))
                  throw new TypeError(
                    "The argument 'number' must be of type number",
                  );
                var r,
                  n = U(this.currency);
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (this.weekdaysList[n] && 0 < this.weekdaysList[n].length)
                  return this.weekdaysList[n];
                var t = _.map(function (e) {
                  return new Date(2017, 4, e);
                });
                return (
                  (this.weekdaysList[n] = t.map(function (e, t) {
                    return {
                      value: t + 1,
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (this.monthsList[n] && 0 < this.monthsList[n].length)
                  return this.monthsList[n];
                var t = j.map(function (e) {
                  return new Date(2017, e - 1);
                });
                return (
                  (this.monthsList[n] = t.map(function (e, t) {
                    return {
                      value: t + 1,
                      name: Intl.DateTimeFormat(r.locale, { month: n }).format(
                        e,
                      ),
                    };
                  })),
  ...
  window.Roblox &&
    ...
    window.Roblox.BundleDetector.bundleDetected("TranslationResources");
}
